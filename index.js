...
// const blurFilter = document.getElementById("blur-test")

// function changeDesc(prev, target) {
//     let oldDesc = corresponding.get(prev)
//     let newDesc = corresponding.get(target)
//     blurFilter.classList.add("transition")
//     oldDesc.classList.add("remove-el")
//     newDesc.classList.remove("remove-el")
//         newDesc.classList.add("display-el")
//     new Promise(function (resolve, reject) {
//         setTimeout(() => resolve(
//             () => {oldDesc.classList.add("remove-el"); blurFilter.classList.remove("blur-filter")}), 350);

//     }).then(() => {
//         oldDesc.classList.remove("display-el");
//         blurFilter.classList.remove("transition")
//         // oldDesc.classList.remove("transition")
...
//   body.classList.add("itsMe-transition");
//   new Promise(function (resolve, reject) {
//     setTimeout(() => resolve(body.classList.add("itsMe-transition")), 900);
//   }).then(() => {
//     body.classList.remove("name-transition");
